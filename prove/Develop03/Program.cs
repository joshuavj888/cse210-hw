...
class Program
{
    static void Main(string[] args)
    {
        ...
        Scripture scripture = new Scripture(scriptureReference, "Trust in the lord with all thine heart; and lean not to thine own " +
         "undestanding. In all thye ways achnowledge him, and he shall direct thy paths.");
